...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Admin12345',
        'HOST': 'blog-application-db.clgsqcce4tvr.us-east-2.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'my-blog-bucket1' # please enter your s3 bucket name
